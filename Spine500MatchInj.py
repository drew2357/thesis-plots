#REDONE SPINE H voltage plot from harnett
#Ca peak 0.00138083
import numpy as np
...
data1 = np.genfromtxt('/Users/andrewcampbell/Desktop/harnettIinjEPSP2.dat',
                     skip_header=1,
                     names=None,
                     dtype='U',
                     delimiter=None)
...
#
data2 = np.genfromtxt('/Users/andrewcampbell/Desktop/big_one23_08RESCUE/SpineHIinjMatchHarnett.dat',
                     skip_header=1,
                     names=None,
                     dtype='U',
                     delimiter=None)
